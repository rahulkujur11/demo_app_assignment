                    ...
                    Container(
                      ...
                      child: RaisedButton(
                        ...
                        onPressed: () {
                          ...
                          Provider.of<Auth>(context, listen: false).createUser(emailController.text, passwordController.text);
                          Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => SuccessfulScreen()));
                        },
                        child: const Text('Sign up', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Colors.white,),),
                      ),
                    ),
